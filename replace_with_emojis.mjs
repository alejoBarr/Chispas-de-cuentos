...
const emojis = [
  // Nubi
  { emoji: "☁️", bg: "#87CEFA" }, { emoji: "🐇", bg: "#87CEEB" }, { emoji: "🧒", bg: "#B0E0E6" }, { emoji: "🍦", bg: "#ADD8E6" }, { emoji: "☀️", bg: "#87CEFA" },
  // Gaspard
...
geminiContent = geminiContent.replace(/return\s*['"]https:\/\/images\.unsplash\.com[^'"]+['"]/g, "return '" + getEmojiSvgUrl('✨📖✨', '#FFD1DC') + "'");
